...
\begin{frame}[fragile]{The Forecasting Workflow}
	\begin{columns}
		...
		\column{0.6\textwidth}
		\begin{figure}
			\includegraphics[width=0.9\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/fpp_tidy_forecasting_workflow.png}
		\end{figure}
	\end{columns}
\end{frame}
...
\begin{frame}[fragile]{Comparing the Methods}
	\begin{figure}
		...
		\caption{Australian quarterly beer production: Mean, Random Walk, Random Walk + Drift and Seasonal Naïve}
	\end{figure}
\end{frame}
...
\begin{frame}[fragile]{Why Prediction Intervals Matter}
	...
	\begin{figure}
		\includegraphics[width=0.5\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/hyndman_forecast_interval_example.png}
...
\begin{frame}[fragile]{Train-Test Split}
	...
	\begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/hyndman_traintest.png}
...
\begin{frame}{Example: Calculating Forecast Errors \& Metrics}
	\begin{figure}
		\centering
		\includegraphics[width=0.8\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/Hyndman_Forecast_Eval_Example.png}
...
\begin{frame}[fragile]{Time Series Cross-Validation}
	...
	\begin{figure}
		\includegraphics[width=0.6\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/uber_backtesting_sliding_window.png}
...
\begin{frame}{Example for two test-training splits}
	\begin{figure}
		\centering
		\includegraphics[width=1.0\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/beispiel_evaluation_mehrere_stuetzzeitpunkte.png}
...
% 	\begin{figure}
% 		\centering
% 		\includegraphics[width=0.9\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/Forecasting_methods.png}
...
% 	\begin{figure}
% 		\includegraphics[width=0.7\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/arma_11_prognose_exr.png}
