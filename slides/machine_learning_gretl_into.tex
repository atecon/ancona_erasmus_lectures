...
% Load template files
\input{template/slides_header.tex}
\input{template/myshortcuts.tex}
...
\begin{frame}[fragile]{ML Fundamentals Overview}
	\begin{figure}
		\centering
		\includegraphics[width=0.75\textwidth]{../../common/figures/overview_supervised_learning_process.png}
...
\begin{frame}[fragile]{Bias-Variance Tradeoff: Visual Example}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\textwidth]{../../common/figures/raschka2019_classification_underfitting_overfitting.png}
...
\begin{frame}{Regularization: Ridge Regression (L2 Penalty)}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.95\textwidth]{../../common/figures/ridge_path_coefficient.png}
		\end{figure}
	\end{columns}
\end{frame}
...
\begin{frame}{Regularization: Lasso Regression (L1 Penalty)}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.88\textwidth]{../../common/figures/james_etal_lasso_coefficient_path.png}
		\end{figure}
	\end{columns}
\end{frame}
...
\begin{frame}{Code Example 1: OLS, Ridge, and Lasso in Gretl}
	...
	\begin{itemize}
		...
		\item \texttt{crossval\_ridge\_lasso.gretl}: Cross-validation to select $\lambda$ for Ridge and Lasso
	\end{itemize}
\end{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}  %%<--- here
            \begin{figure}
                \centering
                \subfigure{
                    \includegraphics[width=.82\textwidth]{../../common/figures/knn_1_circle.png}}
...
\begin{frame}{Class separability \& Hyperparameter Tuning Using CV}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.5\textwidth]{../../common/figures/raschka2019_classification_linear_nonlinear_separability.png}
		\caption{Linear vs. non-linear separability. Source: \citep[p. 23]{raschka2019PythonMachineLearning}.}
	\end{figure}
	\vspace{-0.7cm}
	%\begin{figure}
	%	\centering
	%	\includegraphics[width=0.425\textwidth]{../../common/figures/knn_decision_boundaries.png}
	%	\caption{KNN decision boundary example. Source: \citep[p. 54]{raschka2019PythonMachineLearning}.}
	%\end{figure}

	\begin{figure}
        \centering
        \includegraphics[width=.66\textwidth]{../../common/figures/knn_example_James_etal2017.png}
...
\begin{frame}{KNN Using Time-Series Data}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{../../common/figures/forecasts_grid_unit=Kommi Kontaktlinse_window=450.png}
...
\begin{frame}[fragile]{Code Example 2: K-Nearest Neighbors in Gretl}
	\textbf{File:} \texttt{../code/02\_knn\_classification.inp}

	\vspace{0.2cm}

	\tiny
	\begin{lstlisting}[style=hansl]
# ==============================================================
# Example 2: K-Nearest Neighbors Classification
# Package: knn.gfn (Artur Tarassow)
# Author: PhD Seminar, Ancona 2026
# ==============================================================

# Install and include package
pkg install knn --quiet
include knn.gfn

# Load data
open ../data/TODO_dataset.gdt  # TODO: Classification dataset

# Prepare training and test data
# TODO: Implement train-test split

# Standardize features (important for KNN)
matrix X_train_std = (X_train .- mean(X_train)) ./ sd(X_train)
matrix X_test_std = (X_test .- mean(X_train)) ./ sd(X_train)

# KNN with k=5
# TODO: Check exact knn.gfn function signature
scalar k = 5
matrix predictions = knn(X_train_std, y_train, X_test_std, k)

# Evaluate
scalar accuracy = mean(predictions .== y_test)
print "KNN Accuracy (k=@k): @accuracy"
	\end{lstlisting}
\end{frame}
...
\begin{frame}{Decision Tree}
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=.9\textwidth]{../../common/figures/decision_tree_go_to_beach_from_raschka.png}
...
\begin{frame}{Basic Concepts of Decision Trees}
	\begin{figure}
		\centering
		\includegraphics[width=.9\textwidth]{../../common/figures/tree_basic_terminology.png}
...
\begin{frame}{Example: Modeling Baseball Player Salaries \textbf{I}}
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=.85\textwidth]{../../common/figures/tree_basic_data=hitters.png}
...
\begin{frame}{Example: Modeling Baseball Player Salaries \textbf{II}}
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}  %%<--- here
			\begin{figure}
				\centering
				\includegraphics[width=.85\textwidth]{../../common/figures/tree_basic_partiioned_space_data=hitters.png}
...
\begin{frame}{Binary Classification Tree for a Purchase Decision}
	\begin{columns}
		...
		\begin{column}{0.78\textwidth}
			\includegraphics[width=\textwidth]{../../common/figures/yu_barter_classification_tree.png}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}{Comparison of Model Types}
	\begin{figure}
		\centering
		\includegraphics[width=.62\textwidth]{../../common/figures/comparison_linearmodel_vs_treebased.png}
...
\begin{frame}[fragile]{Code Example 3: Decision Trees in Gretl}
	\textbf{File:} \texttt{../code/03\_decision\_tree.inp}
	...
	\begin{lstlisting}[style=hansl]
# ==============================================================
# Example 3: Decision Tree for Classification/Regression
# Note: Gretl has limited built-in tree support
# Author: PhD Seminar, Ancona 2026
# ==============================================================

# TODO: Determine exact Gretl tree-building function
# Options:
#   1. Use R integration via rpart package
#   2. Use external tree package if available
#   3. Demonstrate concept with logit/probit tree splits

# Load data
open ../data/TODO_dataset.gdt

# For now, demonstrate tree concept with sequential splits
# Split 1: If X1 > threshold, predict category A
# Split 2: Further split based on X2

matrix result = {}
# TODO: Implement tree construction or reference R example

print "Decision tree example structure"
# TODO: Add tree visualization or detailed explanation
	\end{lstlisting}
\end{frame}

\begin{frame}[fragile]{Random Forests: Bootstrap Aggregation}
...
\begin{frame}{Random Forests: Illustration}
	\begin{figure}
		\centering
		\includegraphics[width=0.6\textwidth]{../../common/figures/random_forest_illustrated.png}
...
\begin{frame}{Bagging vs. Random Forests}
	...
	\begin{figure}
		\centering
		\includegraphics[width=.5\textwidth]{../../common/figures/bagging_error_rate_decision_tree.png}
...
\begin{frame}[fragile]{Code Example 4: Random Forests in Gretl}
	\textbf{File:} \texttt{../code/04\_random\_forest.inp}
	...
	\begin{lstlisting}[style=hansl]
# ==============================================================
# Example 4: Random Forests with Feature Importance
# Note: Uses R integration (randomForest package)
# Author: PhD Seminar, Ancona 2026
# ==============================================================
...
# TODO: Create X (features) and y (target) matrices

# Use R integration to fit Random Forest
# TODO: Determine Gretl-R integration syntax

# Install and use randomForest in R:
# rf_model <- randomForest(y ~ ., data=df, ntree=500, mtry=sqrt(p))
...
# TODO: Add permutation importance reference/calculation
# See: https://github.com/atecon/permutation_importance
...
\begin{frame}{Permutation Feature Importance Visualization}
	\begin{figure}
		\centering
		\includegraphics[width=.85\textwidth]{../../common/figures/yu_barter_shopping-variable-importance-permutation.png}
...
\begin{frame}
	\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{../../common/figures/raschka2019_classification_svm_maximum_margin.png}
...
\begin{frame}[fragile]{Code Example 5: Support Vector Machines in Gretl}
	\textbf{File:} \texttt{../code/05\_svm.inp}
	...
	\begin{lstlisting}[style=hansl]
# ==============================================================
# Example 5: Support Vector Machines (libsvm integration)
# Dataset: TODO - ISL classification/regression dataset
# Author: PhD Seminar, Ancona 2026
# ==============================================================
...
# TODO: Prepare training and test data
# Standardize features (important for SVM)

# Linear SVM for classification
# TODO: Check Gretl's SVM function signature

# Possible syntax (needs verification):
# svm y const X1 X2 X3 --kernel=linear --cost=1
# svm y const X1 X2 X3 --kernel=rbf --cost=1 --gamma=0.1

# RBF kernel SVM with cost=1
# TODO: Implement SVM call with appropriate parameters

# Evaluate predictions
# TODO: Compute classification metrics (accuracy, F1, AUC)

# SVM for Regression:
# TODO: Add SVR example with epsilon-insensitive loss
...
\begin{frame}[fragile]{Tree-Based vs. Kernel Methods: Comparison}
	...
	\begin{itemize}
		...
		\item \textbf{SVM/KNN}: Try when trees underperform or data is very high-dimensional
	\end{itemize}
\end{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}  %%<--- here
            ...
            \begin{figure}
                \centering
                \subfigure{
                    \includegraphics[width=1.0\textwidth]{../../common/figures/kfold_approach_k=5_scikitlearn.png}}
...
\begin{frame}{Comparison of LOOCV and k-Fold CV}
    \begin{figure}
        \centering
        \subfigure{
            \includegraphics[width=0.8\textwidth]{../../common/figures/kfold_loocv_comparison_James_etal_2017.png}}
...
\begin{frame}{Cross-Validation}
    \begin{figure}
        \centering
		\includegraphics[width=0.9\textwidth]{../../common/figures/kfold_classification_James_etal_2017.png}
...
\begin{frame}{Imbalanced Class Distribution}
    \begin{figure}
        \centering
		\includegraphics[width=0.85\textwidth]{../../common/figures/kfold_stratified_scikitlearn.png}
    \end{figure}
...
\begin{frame}{Cross-Validation of Time Series Data (and Panel Data)}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}  %%<--- here
            \begin{figure}
                \centering
				\includegraphics[width=1.0\textwidth]{../../Angewandte_Oekonometrie_2_BA/figures/uber_backtesting_sliding_window.png}
...
\begin{frame}[fragile]{Code Example 6: K-Fold Cross-Validation Setup}
	\textbf{File:} \texttt{../code/06\_kfold\_cv.inp}
	...
	\begin{lstlisting}[style=hansl]
# ==============================================================
# Example 6: K-Fold Cross-Validation Setup
# Package: CvDataSplitter.gfn (Artur Tarassow)
# Author: PhD Seminar, Ancona 2026
# ==============================================================

# Install and include package
pkg install CvDataSplitter --quiet
...
scalar k = 5
matrix fold_indices = TODO_create_cv_folds(k, $nobs)
...
loop i=1..k --quiet
	# Get fold indices
	matrix test_idx = (fold_indices == i)
	matrix train_idx = (fold_indices != i)

	# Split data
	matrix y_train = y[train_idx]
	matrix X_train = X[train_idx,]
	matrix y_test = y[test_idx]
	matrix X_test = X[test_idx,]

	# Fit model on training fold
	ols y_train const X_train --quiet
	scalar rmse_fold = $rmse

	# Store error
	matrix cv_errors = cv_errors | rmse_fold
endloop

# Average CV error
scalar cv_error_mean = mean(cv_errors)
print "5-Fold CV RMSE: @cv_error_mean"
	\end{lstlisting}
\end{frame}
...
\begin{frame}{Forecast Errors for Regression}
    \begin{itemize}
        ...
        \begin{equation}
            e_i = y_i - \hat y_i
        \end{equation}
        \item Decomposition of the error into different components: Forecast error = Signal + Noise
        \item Forecast error does not mean 'error' in the sense of 'wrong'.
        \item Forecast errors represent the non-predictable part of the observations -- at least when the model is correctly specified.
...
\begin{frame}{Illustration of the iterations}
	\begin{figure}
		\centering
		\subfigure{
			\includegraphics[width=.58\textwidth]{../../common/figures/kmeans_iterations_from_bishop.png}}
...
\begin{frame}{K-Means: Distance Metric and Initialization}
	\textbf{Distance Metric:}
	\begin{itemize}
		\setlength{\itemsep}{0.15cm}
		\item Default: Euclidean distance $\|\mathbf{x}_i - \boldsymbol{\mu}_k\| = \sqrt{\sum_j (x_{ij} - \mu_{kj})^2}$
		\item Assumes continuous features on similar scales
		\item \textbf{Important:} Standardize features before clustering!
	\end{itemize}

	\vspace{0.2cm}

	\textbf{Initialization Problem:}
	\begin{itemize}
		\setlength{\itemsep}{0.15cm}
		\item K-Means converges to \textbf{local optimum}, not global
		\item Different random starting points $\Rightarrow$ different final clusters
		\item \textbf{Solution}: Run $k$-means multiple times with different initializations, keep best
		\item Alternative: K-Means++ initialization (smarter initial centroids)
	\end{itemize}
\end{frame}
...
\begin{frame}{How many clusters?}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{column}{0.58\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=0.7\textwidth]{../../common/figures/kmeans_elbow_method.png}
...
\begin{frame}{ROC Curve for Binary Classification \textbf{II}}
    \begin{figure}
        \includegraphics[scale=0.35]{../../common/figures/mroz_logit_roc.png}
