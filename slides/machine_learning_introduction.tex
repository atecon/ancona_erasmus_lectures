...
\begin{frame}{ML Fundamentals Overview}
	\begin{figure}
		\centering
...
\begin{frame}{Regularization: Lasso Regression (L1 Penalty)}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.8\textwidth]{../figures/james_etal_lasso_coefficient_path.png}
		\end{figure}
	\end{columns}
\end{frame}
...
\begin{frame}{Class separability \& Hyperparameter Tuning Using CV}
	...
	\begin{figure}
        \centering
        \includegraphics[width=.6\textwidth]{../figures/knn_example_James_etal2017.png}
